...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>z
    <!-- CSS -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="#">Pesantren <Al-Mubarok></Al-Mubarok></a>
    ...
    <div class="jumbotron jumbotron-fluid bg-dark text-white">
        <div class="container text-center">
            <h1 class="display-4">Pondok ‘Pesantren Al-Mubarok</h1>
            <p class="lead">Jl. Karang Indah-Samsat RT 11 RW 02 Kel, Sumur
